  ...
  return (
    <main className="flex-1 pt-32 lg:pt-40 pb-20 relative z-10 px-6 lg:px-8 xl:px-16 w-full max-w-[1400px] mx-auto text-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        >
          <button className="w-full flex items-center gap-3 px-4 py-3 rounded-full bg-indigo-500/10 text-indigo-400 font-semibold border border-indigo-500/20 text-left transition-colors">
            <Settings size={18} /> General
          </button>
          <button className="w-full flex items-center gap-3 px-4 py-3 rounded-full text-[#94A3B8] hover:bg-white/5 hover:text-white font-semibold border border-transparent text-left transition-colors">
        ...
        >
          ...
          <div className="bg-[#0A0F24]/60 backdrop-blur-md border border-white/10 rounded-[2rem] p-8">
            ...
            <button className="px-6 py-2.5 rounded-full font-bold bg-rose-500/10 text-rose-400 border border-rose-500/20 hover:bg-rose-500/20 transition-all">
              Delete Account
            </button>
          </div>
        </motion.div>
