  if (joinDenied) {
    return (
      <div className="flex-1 flex items-center justify-center h-screen bg-[#050816] text-white relative overflow-hidden font-sans">
        ...
        <div className="text-center space-y-6 z-10 max-w-md w-full mx-4 p-10 bg-[#0A0F24]/80 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          ...
          <div>
            <h2 className="text-3xl font-bold text-white mb-2 tracking-tight">Entry Denied</h2>
            <p className="text-[#94A3B8]">The host declined your request to join.</p>
          </div>
          <button type="button" onClick={onLeave} className="w-full py-4 px-6 rounded-2xl font-semibold text-white bg-white/5 hover:bg-white/10 border border-white/10 transition-all hover:-translate-y-0.5">
            Return to Dashboard
          </button>
        </div>
      </div>
    ...
    return (
      <div className="flex-1 flex items-center justify-center h-screen bg-[#050816] text-white relative overflow-hidden font-sans">
        ...
        <div className="text-center space-y-6 z-10 max-w-md w-full mx-4 p-10 bg-[#0A0F24]/80 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          ...
          <div>
            <h2 className="text-3xl font-bold text-white mb-2 tracking-tight">Room Not Found</h2>
    ...
    return (
      <div className="flex-1 flex items-center justify-center h-screen bg-[#050816] text-white relative overflow-hidden font-sans">
        ...
        <div className="text-center space-y-6 z-10 max-w-md w-full mx-4 p-10 bg-[#0A0F24]/80 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          ...
          <div>
            <h2 className="text-3xl font-bold text-white mb-2 tracking-tight">Waiting for Host</h2>
    ...
    return (
      <div className="flex-1 flex items-center justify-center h-screen bg-[#050816] text-white relative overflow-hidden font-sans">
        ...
        <div className="text-center space-y-6 z-10 max-w-md w-full mx-4 p-10 bg-[#0A0F24]/80 backdrop-blur-2xl border border-white/10 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          ...
          <div>
            <h2 className="text-3xl font-bold text-white mb-2 tracking-tight">Opening Meeting</h2>
  ...
  return (
    <div className="flex-1 flex h-screen overflow-hidden bg-[#050816] text-white font-sans relative">
      ...
      <div className={`flex-1 flex flex-col transition-all duration-300 relative z-10 ${isChatOpen ? 'pr-0 md:pr-80' : 'pr-0'}`}>
        ...
        <div className="absolute top-0 left-0 right-0 z-30 bg-gradient-to-b from-[#050816] to-transparent">
          <div className="flex items-center justify-between px-4 sm:px-6 md:px-8 py-4 sm:py-6">
            ...
            <div className="flex items-center space-x-2 bg-[#0A0F24]/60 backdrop-blur-xl px-4 py-2 rounded-full border border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.3)]">
        ...
        <div className="flex-1 p-3 sm:p-4 md:p-6 lg:p-8 pt-20 sm:pt-24 md:pt-28 pb-32 sm:pb-28 md:pb-24 overflow-y-auto w-full h-full flex items-center justify-center">
          <div className={`${getGridClass()} gap-3 sm:gap-4 md:gap-6 w-full h-full max-w-7xl mx-auto`}>
            {/* Local Video */}
            <div className={`bg-[#0A0F24]/80 backdrop-blur-md rounded-2xl md:rounded-3xl relative overflow-hidden flex items-center justify-center min-h-[160px] sm:min-h-[200px] md:min-h-[220px] border border-indigo-500/40 shadow-[0_0_30px_rgba(99,102,241,0.15)] group ${allParticipantsCount === 1 ? 'max-w-4xl w-full aspect-video shadow-[0_0_50px_rgba(99,102,241,0.2)]' : ''}`}>
              {isInitializing && (
              ...
              {!isInitializing && mediaError && (
                <div className="absolute inset-0 z-20 flex flex-col items-center justify-center space-y-4 p-6 bg-[#0A0F24]/80 backdrop-blur-sm">
                  ...
                  <button type="button" onClick={handleRetryCamera} className="px-5 py-2.5 bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-300 border border-indigo-500/50 rounded-xl text-sm font-semibold transition-all">
                    Retry
                  </button>
                </div>
              )}
              ...
              <div className="absolute bottom-4 left-4 bg-[#050816]/80 backdrop-blur-xl text-white text-xs sm:text-sm font-semibold px-3 py-1.5 rounded-lg flex items-center space-x-2 border border-white/10 shadow-lg">
            ...
            {participants.map((participant) => {
              ...
              return (
                <div
                  ...
                  className="bg-[#0A0F24]/80 backdrop-blur-md rounded-2xl md:rounded-3xl relative overflow-hidden flex items-center justify-center group border border-white/10 shadow-[0_4px_20px_rgba(0,0,0,0.3)] aspect-video min-h-[160px] sm:min-h-[200px] md:min-h-[220px]"
                >
        ...
        {isHost && waitingUsers.length > 0 && (
          <div className="absolute top-20 right-4 md:right-8 z-50 w-[calc(100vw-2rem)] sm:w-80 max-w-[calc(100vw-2rem)] bg-[#0A0F24]/95 backdrop-blur-2xl border border-indigo-500/30 rounded-2xl shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5),0_0_20px_rgba(99,102,241,0.2)] p-5">
            <h3 className="text-white font-bold mb-4 flex items-center text-sm sm:text-base tracking-wide">
            ...
            <div className="space-y-3 max-h-60 overflow-y-auto pr-1 custom-scrollbar">
              {waitingUsers.map((user) => (
                <div key={user.socketId} className="flex items-center justify-between bg-[#160B2A]/50 border border-white/5 p-3 rounded-xl hover:border-white/10 transition-colors">
            ...
            {isHost && (
              <div className="flex items-center space-x-3 sm:space-x-4 pr-3 sm:pr-4 border-r border-white/10">
                <div className="hidden sm:block">
                  <p className="text-[10px] text-indigo-300 font-semibold uppercase tracking-wider mb-0.5">Meeting Code</p>
      ...
      <div
        className={`
        fixed md:absolute right-0 top-0 bottom-0 w-full md:w-[350px] bg-[#0A0F24]/95 backdrop-blur-3xl md:border-l border-white/10 flex flex-col z-40 transition-transform duration-500 shadow-[-20px_0_40px_rgba(0,0,0,0.5)]
