...
const variants = {
  ...
  brand: 'bg-indigo-500 text-white light:text-slate-900 hover:bg-indigo-600 shadow-[0_0_20px_rgba(37,99,235,0.25)] hover:shadow-[0_0_30px_rgba(37,99,235,0.4)] border border-white/10 light:border-slate-200',
  secondary: 'bg-white/[0.03] text-white light:text-slate-900 border border-white/10 light:border-slate-200 hover:bg-white/[0.08] hover:border-white/20 backdrop-blur-sm',
