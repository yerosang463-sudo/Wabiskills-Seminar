...
let content = fs.readFileSync('frontend/src/components/MeetingRoom.jsx', 'utf8');
...
fs.writeFileSync('frontend/src/components/MeetingRoom.jsx', content);
console.log('Fixed MeetingRoom.jsx styling.');
